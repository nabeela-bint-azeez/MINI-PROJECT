...
urlpatterns = [
    ...
    url('assignd/',include('assigndoctor.url')),
    url('doctor/',include('doctor.url')),
    # url('hospital/',include('hospital.url')),
    url('login/',include('login.url')),
    # url('organcollection/', include('organcollection.url')),
    url('organdonation/', include('organdonation.url')),
    url('organrequest/', include('organrequest.url')),
